...
| [`docs/PILOT_CONTROLLED_OPERATING_PLAN.md`](PILOT_CONTROLLED_OPERATING_PLAN.md) | Plan operativo del piloto controlado: el smoke test de Fase 6 se repite antes de cada sesión del piloto |

---

*Este checklist cubre el MVP XPAY — Fases 1 a 33. Actualizar cuando se agreguen nuevos módulos, flujos o criterios de aprobación.*
