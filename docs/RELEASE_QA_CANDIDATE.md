...
| [`docs/PREPRODUCTION_GAPS_AND_REAL_MONEY_CHECKLIST.md`](PREPRODUCTION_GAPS_AND_REAL_MONEY_CHECKLIST.md) | Checklist de brechas para preproducción y dinero real: evaluación estratégica posterior al piloto controlado |
